...
class icarl_regularization(BaseLearner):
    ...
    def save_model(self):
        if len(self._multiple_gpus) > 1:
            torch.save(self._network.module.state_dict(), "./saved_model/icarl_regularization_v1_duplex_{}_{}.pt".format(duplex, self._cur_task))
        else:
            torch.save(self._network.state_dict(), "./saved_model/icarl_regularization_v1_duplex_{}_{}.pt".format(duplex, self._cur_task))
