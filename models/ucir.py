...
class UCIR(BaseLearner):
    def __init__(self, args):
        ...
        self._lamda_base = args['lamda_base']
    ...
    def incremental_train(self, data_manager):
        logging.info('All parameters: convnet_type: {}, epochs: {}, lrate: {}, milestones: {}'.format(
            self._convnet_type, epochs, lrate, milestones))
        logging.info('lrate_decay: {}, batch_size: {}, weight_decay: {}'.format(lrate_decay, batch_size, weight_decay))
        logging.info('memory_per_class: {}, lamda_base: {}, K: {}, margin: {}'.format(self._memory_per_class, self._lamda_base, K, margin))
        self._cur_task += 1
