...
class icarl_regularization_v4(BaseLearner):
    ...
    def save_model(self):
        if len(self._multiple_gpus) > 1:
            torch.save(self._network.module.state_dict(), "./icarl_regularization_v4_duplex_{}_{}.pt".format(duplex, self._cur_task))
        else:
            torch.save(self._network.state_dict(), "./icarl_regularization_v4_duplex_{}_{}.pt".format(duplex, self._cur_task))
